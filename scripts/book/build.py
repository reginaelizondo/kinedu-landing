...
C = {
 "en": dict(
  ...
  au_p="Luis brings his experience building Kinedu and raising four daughters to the questions at the heart of Big Bang Baby: how children develop, and how parents can support them.",
 ...
 "es": dict(
  ...
  au_p="Luis lleva su experiencia construyendo Kinedu y criando a cuatro hijas a las preguntas que están en el corazón de Big Bang Baby: cómo se desarrollan los niños y cómo pueden apoyarlos sus papás.",
 ...
 "pt": dict(
  ...
  au_p="Luis leva sua experiência construindo o Kinedu e criando quatro filhas às perguntas que estão no coração de Big Bang Baby: como as crianças se desenvolvem e como os pais podem apoiá-las.",
...
/* 1. entrada */
.bk-hero{padding:160px 24px 80px}
.bk-hero::after{content:"";position:absolute;left:66%;top:58%;width:760px;height:600px;transform:translate(-50%,-50%);pointer-events:none;background:radial-gradient(circle at center,rgba(255,226,168,.2) 0%,rgba(233,199,126,.13) 18%,rgba(214,168,92,.05) 42%,transparent 66%);filter:blur(10px)}
...
/* 6. autor + cierre */
.bk-end{padding:84px 24px}
.bk-end::after{content:"";position:absolute;left:50%;top:78%;width:900px;height:600px;transform:translate(-50%,-50%);pointer-events:none;background:radial-gradient(circle at center,rgba(255,226,168,.18) 0%,rgba(233,199,126,.1) 20%,transparent 62%);filter:blur(12px)}
...
@media(max-width:900px){
  .bk-hero{padding:124px 20px 56px}
  ...
  .bk-qs,.bk-uni,.bk-ban,.bk-in,.bk-end{padding:56px 20px}
...
<section class="bk-end bk-navy bk-stars" id="get">
  <div class="bk-wrap">
    <div class="bk-au">
