...
.bk-hero .bk-subtitle{font-size:clamp(1.05rem,1.7vw,1.3rem);line-height:1.35;color:#52607A;margin:0 0 28px;font-weight:600;letter-spacing:-.01em;text-wrap:balance}
.bk-hero .bk-q{font-size:clamp(1.3rem,2.1vw,1.7rem);line-height:1.25;font-weight:800;color:#081B46;margin:0 0 14px;letter-spacing:-.02em;text-wrap:balance}
.bk-hero .bk-p{font-size:clamp(1rem,1.4vw,1.15rem);line-height:1.6;color:#52607A;margin:0 0 28px;max-width:600px;text-wrap:pretty}
.bk-hero .bk-btn-gold{background:#087BF3;color:#fff;box-shadow:0 18px 40px -16px rgba(8,123,243,.6)}
.bk-hero .bk-btn-gold:hover{background:#0B6BD0}
.bk-hero .bk-btn-ghost{color:#081B46;border-color:#D9DFEA;background:#fff}
.bk-hero .bk-btn-ghost:hover{border-color:#081B46}
.bk-hero .bk-date{color:#9A7423}
.bk-hero .bk-date::before{background:#E9C77E}
.bk-cover{position:relative;display:flex;justify-content:center;padding:36px 0}
.bk-hero .bk-cover::before{content:"";position:absolute;left:50%;top:50%;width:520px;height:520px;transform:translate(-50%,-50%);border-radius:50%;background:radial-gradient(circle,rgba(233,199,126,.55) 0%,rgba(233,199,126,.22) 38%,rgba(233,199,126,0) 68%);pointer-events:none}
...
@media(max-width:900px){
  ...
  .bk-hero .bk-cover::after{width:260px;height:260px}
  .bk-hero .bk-wrap{grid-template-columns:1fr;gap:20px}
