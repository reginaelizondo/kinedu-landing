...
_PRON=[(">Social<",">Social-emotional<"),("Now they can study the whole room","Sees more of the room"),("Now they can turn toward your voice","Can turn toward your voice"),("Now they can hold your gaze","Has more face-to-face moments with you"),("…that one skill opens three more doors:","…and that one skill opens new possibilities:"),("Dressing &amp; feeding themselves","Dressing and feeding themselves"),("Dressing & feeding themselves","Dressing and feeding themselves")]
for _a,_b in _PRON:
...
COUPLING_SVG = """<div class="sci26-chart" style="max-width:520px"><h3 style="font-size:19px;font-weight:800;color:#081B46;margin:0 0 8px">Early on, the four areas grow closely together.</h3>
...
</svg><p class="cap">The connection between the four areas falls by almost half during the first year, then remains more stable through the ages shown · Kinedu record, 2020–2023 · children observed at consecutive ages between 2 and 35 months · technical name: within-child coupling</p></div>"""
# ====================================================================
...
.sci-disc>summary::after{content:"↓";font-size:18px;font-weight:800;color:var(--sciacc);transition:transform .2s ease}
.sci-disc[open]>summary::after{transform:rotate(180deg)}
.sci-disc>summary:hover{background:#FAF8F5}
.sci-disc .bd{padding:4px 22px 24px;border-top:1px solid #F1ECE5}
.sci-disc .bd .sci-prose p{font-size:16px;line-height:1.65;margin:18px 0 0}
.sci-disc .bd .sci26-chart{margin:22px auto 0}
...
.sci-path{display:flex;flex-direction:column;gap:0;max-width:460px;margin-top:26px}
.sci-path::before{left:10px;right:auto;top:10px;bottom:34px;width:3px;height:auto;background:linear-gradient(180deg,#E4DED4,#087BF3)}
.sci-path .st{display:grid;grid-template-columns:24px 1fr;column-gap:16px;text-align:left;padding:0 0 22px;align-items:start}
.sci-path .k{grid-column:2;height:auto;margin:0 0 3px;line-height:1.3}
.sci-path .dot{grid-column:1;grid-row:1/span 2;justify-self:center;margin:4px 0 0;width:18px;height:18px}
.sci-path .last .dot{width:22px;height:22px;margin-top:2px;box-shadow:0 0 0 5px rgba(8,123,243,.15)}
.sci-path b{grid-column:2;max-width:none;margin:0;font-size:17px}
.sci-path .last{padding-bottom:0}
.sci-spec .bar{display:none}
.sci-spec .legend{grid-template-columns:1fr;gap:10px;margin-top:6px}
.sci-spec .legend>div{display:grid;grid-template-columns:32px 1fr;column-gap:12px;align-items:start;padding:12px 14px 12px 12px;border-radius:14px;background:#fff;border:1px solid #EBE6DF;border-left:5px solid var(--c)}
.sci-spec .legend img{margin:0;grid-row:1/span 2}
.sci-spec .legend b{margin:0;font-size:16px}
.sci-spec .legend p{grid-column:2;margin-top:2px}
}
...
<div class="legend">
<div style="--c:#913FA3"><img src="/images/states/upcoming.png" alt="" width="32" height="32" loading="lazy"><b style="color:#913FA3">Upcoming</b><p>Usually develops at a later age.</p></div>
<div style="--c:#1248B7"><img src="/images/states/reinforce.png" alt="" width="32" height="32" loading="lazy"><b style="color:#1248B7">Reinforce</b><p>Expected around this age; still developing.</p></div>
<div style="--c:#3EB646"><img src="/images/states/ontrack.png" alt="" width="32" height="32" loading="lazy"><b style="color:#3EB646">On track</b><p>Showing at the expected age.</p></div>
<div style="--c:#D9A800"><img src="/images/states/mastered.png" alt="" width="32" height="32" loading="lazy"><b style="color:#D9A800">Mastered</b><p>Showing consistently.</p></div>
</div>
</div>
...
p1_product = ('<section id="assessment" class="sci26" style="--sciacc:#2EA84F">'
 ...
 '<div class="sci-prose"><p>We compare your answers with patterns in caregiver reports across ages. Together, they help us understand which skills your baby is developing. You don’t need special training to answer.</p></div>'
 + CH_HEAD + '</div></details>'
 '</div></section>')
...
COUPLING_SVG = COUPLING_SVG.replace('<p style="font-size:14.5px;color:#52607A;line-height:1.6;margin:0 0 16px">Following the same children from 2 to 35 months.</p>',
                                    '<p style="font-size:14.5px;color:#52607A;line-height:1.6;margin:0 0 16px">As children get older, each area begins to follow its own path, while still influencing the others.</p>')
...
p2_one = sec("One · Together", 'Early skills <span class="sci-squig">develop together.</span>',
 "When your baby lifts their head, they can see more of the world and find new ways to respond to you. It’s one example of how movement, learning, communication, and relationships connect.",
...
p2_five = sec("Five · Unpredictable", 'Your child’s pace <span class="sci-squig">can change.</span>',
 "What your child is doing today doesn’t tell us how quickly the next skill will come. Where they are today and their pace of development are different things.",
...
<div class="sci26-chart" style="max-width:1000px;margin:26px auto 0"><h3 style="font-size:20px;font-weight:800;color:#081B46;margin:0 0 8px">An assessment is a snapshot, not a prediction.</h3>
...
p3_hero = hero("The science behind Kinedu · Part 3 of 3",
    ...
    "Supporting your child doesn’t have to mean adding more to your day. Four everyday forces, and all of them are already in your hands: Connect, Guide, Buffer, Repeat.",
    "", badges=False)
...
FOUR=[("#play","Connect","Play","How you play together, and the kinds of play.","play","#2EA84F","#E4F6E7"),
      ("#relationships","Guide","Relationships","Push, protect, repair, model, and talk.","heart","#F7567C","#FBE3ED"),
      ("#stress","Buffer","Stress","The kinds of stress, and why most of it isn’t toxic.","shield","#E8A33D","#FDEBD8"),
      ("#predictability","Repeat","Routines","The routines that give your child’s day its shape.","clock","#913FA3","#F1E7F3")]
p3_open = sec("The four forces", 'Connect. Guide. Buffer. <span class="sci-squig">Repeat.</span>',
 "The milestones in Part 2 are what you can see. What holds them together is invisible: how you play, how you relate, how you handle stress, and the routines you keep. None of it shows up on a chart. All of it is yours.",
...
p3_play = sec("Connect · Play", 'Play starts with the back-and-forth <span class="sci-squig">between you.</span>',
 "Your baby makes a sound. You respond. They respond again. That exchange is play, and it starts in the first weeks, long before anyone would call it playing. You don’t need special toys: your face, your voice, and your attention are the material.",
 """<div class="sci-rally">
...
"""+line("As your child grows, play gets richer and your role shifts: sometimes they lead, sometimes you set things up, sometimes you show them how.")+"""
<div class="sci-spec2">
<div class="ends"><span>They lead</span><span>You guide</span></div>
...
<div class="cols">
<div style="--c:#2EA84F"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="12" width="8" height="8" rx="1.5"/><rect x="13" y="12" width="8" height="8" rx="1.5"/><rect x="8" y="3" width="8" height="8" rx="1.5"/></svg></span><span class="role">Your baby leads</span><b>Free play</b><p>Your child chooses what to do and how. This is where creativity and curiosity get practice.</p></div>
<div style="--c:#087BF3"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 8h5l-1 11H4zM9.5 8h5l-1 11h-3zM16 8h5l-1 11h-3z"/></svg></span><span class="role">You set it up, they run it</span><b>Guided play</b><p>You offer a prompt or a challenge and follow their lead. Good for specific skills like shapes, counting, and switching between tasks.</p></div>
<div style="--c:#E8A33D"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="8" cy="8" r="1.3" fill="currentColor"/><circle cx="16" cy="8" r="1.3" fill="currentColor"/><circle cx="12" cy="12" r="1.3" fill="currentColor"/><circle cx="8" cy="16" r="1.3" fill="currentColor"/><circle cx="16" cy="16" r="1.3" fill="currentColor"/></svg></span><span class="role">Rules, with room to play</span><b>Games</b><p>Taking turns, following rules, trying again.</p></div>
<div style="--c:#913FA3"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 20h16M6 20V9a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v11M9 7V5a3 3 0 0 1 6 0v2M9 12h6M9 16h6"/></svg></span><span class="role">You lead</span><b>Direct instruction</b><p>You show, they try. Useful for specific skills like tying shoes, but on its own it’s not play.</p></div>
</div>
</div>
"""+take("There’s no single right way to play. <span class=\"mk\">Ask what you want to nurture right now, with this child.</span>")
 +line("What makes it play: it’s fun, it means something to them, they’re doing rather than watching, they can try again, and you’re in it together.")
...
<div class="c" style="background:#E4F6E7"><b>Positive</b><p>A hard puzzle, the first day at school, hearing no. Brief, normal, and back to calm with you nearby. Your child needs this kind.</p></div>
<div class="c" style="background:#FDEBD8"><b>Tolerable</b><p>A medical procedure, a move, a scare. Real stress, but a caring adult absorbs enough of it for your child to recover.</p></div>
<div class="c" style="background:#FBE3ED"><b>Toxic</b><p>Prolonged, severe, and with no adult to buffer it. This is what damages development, and it isn’t one bad day or one bad week.</p></div>
</div>
"""+line("Saying no, holding a limit, letting them feel frustrated: that’s positive stress, and it’s necessary.")
 +take("The buffer isn’t the absence of the stressor. <span class=\"mk\">It’s you being there.</span>")
...
p3_closer = '<section class="sci26 sci26-plain" style="padding:44px 20px 56px"><div class="sci26-wrap" style="max-width:900px;text-align:center"><p class="sci-mantra" style="margin:0">Connect. Guide. Buffer. Repeat.</p><p class="sci-line" style="margin-top:14px"><strong>The four forces aren’t a menu. They’re one thing: you, showing up, day after day.</strong></p><p class="sci-line" style="margin-top:18px">Find ideas for putting these principles into practice with your child.</p><p style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-top:24px">'+cta("Explore Kinedu", TRY)+cta("Take the free assessment", ASSESS, False)+'</p>'+DEEP_LINKS+'</div></section>'
