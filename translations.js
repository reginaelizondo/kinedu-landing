window.TRANSLATIONS = {
  en: {
    ...
    'founder.story.p1': 'I\'m Luis, the founder and a dad of four amazing girls. Like many parents, I often wondered, "Am I doing enough to support my children\'s development?" That\'s why I built Kinedu—a resource I wish I had from the beginning of my parenting journey.',
    'founder.story.p2': 'Kinedu isn\'t just an app; it\'s your personalized guide, created by experts, to support your child\'s development. From sleep and motor skills to cognitive growth, Kinedu provides daily activities and advice tailored to your child\'s needs—so you can know EXACTLY what to do everyday.',
  ...
  es: {
    ...
    'founder.story.p1': 'Soy Luis, el fundador y papá de cuatro increíbles niñas. Como muchos padres, a menudo me preguntaba: "¿Estoy haciendo lo suficiente para apoyar el desarrollo de mis hijas?" Por eso creé Kinedu—un recurso que desearía haber tenido desde el inicio de mi camino como papá.',
    'founder.story.p2': 'Kinedu no es solo una app; es tu guía personalizada, creada por expertos, para apoyar el desarrollo de tu hijo. Desde el sueño y las habilidades motoras hasta el crecimiento cognitivo, Kinedu te ofrece actividades diarias y consejos adaptados a las necesidades de tu hijo—para que sepas EXACTAMENTE qué hacer cada día.',
  ...
  pt: {
    ...
    'founder.story.p1': 'Sou Luis, o fundador e pai de quatro meninas incríveis. Como muitos pais, eu frequentemente me perguntava: "Estou fazendo o suficiente para apoiar o desenvolvimento das minhas filhas?" Por isso criei o Kinedu—um recurso que eu gostaria de ter tido desde o início da minha jornada como pai.',
    'founder.story.p2': 'O Kinedu não é apenas um app; é o seu guia personalizado, criado por especialistas, para apoiar o desenvolvimento do seu filho. Do sono e habilidades motoras ao crescimento cognitivo, o Kinedu oferece atividades diárias e conselhos adaptados às necessidades do seu filho—para que você saiba EXATAMENTE o que fazer todos os dias.',
